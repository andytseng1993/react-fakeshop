        ...
        <div style={{marginBottom:20}}>
            ...
            {comfirmed && 
                <div className={classes.billingAddress}>
                    {comfirmed && <button onClick={handleEdit} className={classes.edit} >Edit</button>}
            ...
            {!comfirmed &&
                <AddressForm phoneInput='false' leftBtnName='Clear' rightBtnName='Use this Address' address={billingAddress} setAddress={setBillingAddress}
